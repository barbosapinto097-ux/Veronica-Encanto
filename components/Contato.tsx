export default function Contato() {
  return (
    <section id="contato" style={{ padding: "6rem 0", background: "#1e1118", textAlign: "center" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2.5rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,3.5vw,2.8rem)", color: "#fff" }}>
            Entre em <em style={{ fontStyle: "italic", color: "#f5d0d8" }}>contato</em>
          </h2>
        </div>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <a
            href="https://wa.me/5579998552108"
            target="_blank"
